 ...
 */
public class TelaSelecionarComanda extends javax.swing.JDialog
{
    ...
    public TelaSelecionarComanda(SigeveView parent, boolean modal, BancoDeDados bd) 
    {
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(sigeve.SigeveApp.class).getContext().getResourceMap(TelaSelecionarComanda.class);
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(sigeve.SigeveApp.class).getContext().getActionMap(TelaSelecionarComanda.class, this);
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(tfIdentificacao, javax.swing.GroupLayout.DEFAULT_SIZE, 385, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    {//GEN-HEADEREND:event_tfIdentificacaoKeyReleased
        ...
        if ( identificacao.matches( "\\d+" ) )
        {
            ...
            {
                Logger.getLogger( TelaSelecionarComanda.class.getName() ).log( Level.SEVERE, null, ex );
            }
        }
        // Caso se digite outra coisa que não um dígito.
        else
        {
